...
sweep_params = {
    "config.dataset.num_supernodes": [32, 64, 128, 256, 64, 64, 64, 64, 64, 128, 128],
    "config.dataset.normalize_charts": [True, True, True, True, True, True, True, True, True, True, True],
    "config.encoder_supernodes_cfg.max_degree": [5, 5, 5, 10, 10, 10, 15, 15, 15, 15, 15],
    "config.encoder_supernodes_cfg.gnn_dim": [64, 64, 64, 64, 128, 128, 128, 64, 64, 128, 128],
    "config.encoder_supernodes_cfg.perc_dim": [256, 256, 256, 64, 128, 128, 128, 64, 64, 128, 128],
    "config.encoder_supernodes_cfg.perc_num_heads": [4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8],
    "config.modulated_siren_cfg.omega_0": [1.0, 3.0, 5.0, 1.0, 3.0, 5.0, 1.0, 3.0, 5.0, 3.0, 3.0],
    "config.modulated_siren_cfg.num_layers": [1, 2, 3, 3, 2, 2, 3, 2, 2, 2, 2],
    "config.modulated_siren_cfg.hidden_dim": [256, 128, 256, 64, 128, 128, 128, 128, 128, 128, 128],
}
...
# Paths
script_path = "$HOME/mpinns/universal_autoencoder/experiments/coil/fit_universal_autoencoder_coil.py"
output_dir = f"/scratch-shared/rvalperga/mpinns/universal_autoencoder/experiments/coil/{job_name}"
template_path = "/home/rvalperga/mpinns/universal_autoencoder/experiments/coil/template.slurm"
