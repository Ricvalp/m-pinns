...
def get_config():
    ...
    cfg.checkpoint.save_every = 1000  # Always save checkpoint at the end of training
    ...
    cfg.model.gnn_dim = 64  # GNN hidden dimension
    cfg.model.max_supernodes = 32  # Maximum number of supernodes
    # Encoder parameters
    cfg.model.enc_dim = 64  # Encoder hidden dimension
